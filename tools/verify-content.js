...
const requiredSnippets = [
  ...
  'id="servicios"',
  'id="ejemplos"',
  'De solo Instagram a una página que explica y genera confianza',
  '¿No estás seguro de por dónde empezar?',
  'Sistema propio para reemplazar planillas',
  ...
  'Necesito un sistema de ventas / stock o caja',
  ...
  'Revisión gratis',
  'Tres señales de que conviene ordenar lo digital',
  'Dos formas concretas de ayudarte',
  'Resultado:',
  'Pedir revisión gratis',
  'Ver más preguntas',
  'https://martindelucca.me/',
  'https://martindelucca.me/assets/og-image.png',
...
const forbiddenSnippets = [
  ...
  'Landing responsive',
  'una landing',
  'Cómo se ordena el negocio',
  'Páginas web &middot; sistemas de gestión',
  'https://martindelucca.github.io/portfolio/assets/og-image.png'
];
